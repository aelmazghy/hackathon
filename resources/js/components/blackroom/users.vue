        ...
        <div class="text-center">
            ...
            >
                <v-card>
                    ...
                    <v-card-actions>
                        ...
                        <v-btn
                            color="error"
                            @click="deleteUserConfirm(userIdToDelete)"
                        >
                            Supprimer
                        </v-btn>
                    </v-card-actions>
            ...
            >
                <v-card>
                    ...
                    <v-form @submit.prevent="editUserConfirm()" v-model="valid2"  ref="userForm">
                        <v-card-text>
            ...
            >
                <v-card>
                    ...
                    <v-form @submit.prevent="editPasswordUserConfirm()" v-model="valid3"  ref="userForm">
                        <v-card-text>
                    ...
                    <v-card-actions>
                        ...
                        <v-btn
                            color="success"
                            @click="editPasswordUserConfirm(editedUserPassword)"
                            :disabled="!valid3"
                        >
                            Modifier
                        </v-btn>
    ...
    export default {
        ...
        methods: {
            ...
            editUser: function (userId){
                this.editedUser = this.$store.state.users.find( user => user.id === userId);
            ...
            editPasswordUser: function (userId){
                this.editedUserPassword = this.$store.state.users.find( user => user.id === userId);
                this.dialogEditPassword = true
            },
            editPasswordUserConfirm: function (){
                this.$store.dispatch('editPasswordUserConfirm', {id: this.editedUserPassword.id, password:this.password});
